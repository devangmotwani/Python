...
#  12 times 2 is 24
#  --------------------
with open("sample.txt2",'w') as filename:
    #for line in filename:
    #print("\nThis is a test",file=filename)
    print("\n")
    for table in range(2,13):
        for count in range(1,13):
            print("{0:2} times {1:2} is {2:<3}".format(count,table,count*table),file=filename)
        print("-"*20,file=filename)
